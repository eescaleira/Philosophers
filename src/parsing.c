...
/*   Updated: 2024/04/17 16:23:50 by eescalei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	table->philo_nbr = check_positive_output(ft_atoi(av[1]));
	table->time_to_die = check_positive_output(ft_atoi(av[2]));
	table->time_to_eat = check_positive_output(ft_atoi(av[3]));
	table->time_to_sleep = check_positive_output(ft_atoi(av[4]));
	table->nbr_limit_meals = -1;
	if(NULL != av[5])
		table->nbr_limit_meals = check_positive_output(ft_atoi(av[5]));
}
